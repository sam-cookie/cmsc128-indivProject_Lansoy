    ...
    function handleAddTask() {
        ...
        if (taskText !== '') {
            ...
            .then(task => {
                ...
                // Find the correct container based on context
                let backlogContainer;
                if (isCollaboration) {
                    // For collaborative tasks, find the backlog drop zone
                    ...
                    // For personal tasks, use the task card container
                ...
                if (!backlogContainer) {
                    ...
                    // Fallback: append to body and let refresh handle it
                ...
                // Sort tasks if not collaborative
                if (!isCollaboration) {
                    sortTasks();
                }
            })
